function results = B_AIF_fitting_func_conf(results_a_path,start_time,end_time,start_injection,end_injection,fit_aif,import_aif_path,time_resolution, timevectpath, XIF_name, hippocampusname)
...
ylabel('Signal (a.u)');
xlabel('Time (min)');
saveas(b, fullfile(PathName1, [rootname +'_AIF_fitting.fig']));


full_jpg = fullfile(PathName1, [rootname XIF_name hippocampusname '_AIF_fitting.jpg']);
