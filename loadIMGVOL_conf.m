function [TUMOR, LV, NOISE, DYNAMIC, dynampath, dynamname, rootname, hdr, res, sliceloc, errormsg] = loadIMGVOL_conf(handles)


% Takes handles, loads the image files and outputs image volume.


disp("START LOADIMG INPUT")
